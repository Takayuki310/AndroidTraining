...
public class MainActivity extends Activity {
	...
	private MainPhotoViewPager mPager;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mPager = (MainPhotoViewPager) findViewById(R.id.pager);
		mPager.setMainPhotoUrlList(imageUrls, this);

	}

	@Override
	protected void onDestroy() {
		mPager.getAdapter().stopImageHandler();
		super.onDestroy();
	}
